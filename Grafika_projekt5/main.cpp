...
int main()
{
	...
	Shader simpleDepthShader("shadow_mvp.vs", "shadow_mvp.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightProjection = glm::perspective(glm::radians(120.0f), (GLfloat)SHADOW_WIDTH / (GLfloat)SHADOW_HEIGHT, near_plane, far_plane); // note that if you use a perspective projection matrix you'll have to change the light position as the current light position isn't enough to reflect the whole scene
		//lightProjection = glm::ortho(-10.0f, 10.0f, -10.0f, 10.0f, near_plane, far_plane);
		lightView = glm::lookAt(lamp.LightPos, glm::vec3{ -6.17257,2.26399, 2.78777 }, glm::vec3(0.0, 1.0, 0.0));
